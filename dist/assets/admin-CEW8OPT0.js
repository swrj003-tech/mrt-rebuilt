...
`).filter(Boolean),c.price=c.price?parseFloat(c.price):null,c.originalPrice=c.originalPrice?parseFloat(c.originalPrice):null,c.ratingValue=parseFloat(c.ratingValue)||0,c.currency=c.currency||`USD`;let l;if(n){if(l=await r(`/products/${e.id}`,{method:`PUT`,body:JSON.stringify(c)}),l?.error){i(l.error,`error`),o.disabled=!1,o.innerHTML=`<span class="material-symbols-outlined">save</span> Update Product`;return}i(`Product updated`)}else{if(l=await r(`/products`,{method:`POST`,body:JSON.stringify(c)}),l?.error){i(l.error,`error`),o.disabled=!1,o.innerHTML=`<span class="material-symbols-outlined">add_circle</span> Create Product`;return}i(`Product created`)}a.remove(),setTimeout(()=>d(),100)})}async function h(e){let t=await r(`/categories`);t&&(e.innerHTML=`
      ...
      <form id="blog-form">
        ...
        <div class="form-group">
          ...
          <div style="display:flex;gap:0.5rem;align-items:center">
            <input type="text" name="coverImage" id="blog-cover-image-path" value="${e?.coverImage||``}" placeholder="https://example.com/image.jpg">
            <button type="button" class="btn btn-secondary" id="btn-preview-blog-cover">
              <span class="material-symbols-outlined">visibility</span>
              <span class="btn-label">Preview</span>
            </button>
          </div>
          <div id="blog-cover-preview-wrap" style="display:${e?.coverImage?`block`:`none`};margin-top:0.75rem">
            <img id="blog-cover-preview-img" src="${e?.coverImage||``}" alt="" style="max-height:120px;max-width:100%;border-radius:var(--radius-md);border:1px solid var(--border);object-fit:cover">
          </div>
  ...
  `,document.body.appendChild(n),n.querySelector(`#modal-cancel`).addEventListener(`click`,()=>n.remove()),n.querySelector(`#modal-close-x`).addEventListener(`click`,()=>n.remove()),n.addEventListener(`click`,e=>{e.target===n&&n.remove()});let a=n.querySelector(`#blog-cover-image-path`),o=n.querySelector(`#blog-cover-preview-wrap`),s=n.querySelector(`#blog-cover-preview-img`),c=(e=a.value.trim())=>{if(!e){o.style.display=`none`;return}s.src=e,s.onerror=()=>{i(`Could not load image preview`,`error`),o.style.display=`none`},s.onload=()=>{o.style.display=`block`}};n.querySelector(`#btn-preview-blog-cover`).addEventListener(`click`,()=>c()),E(n.querySelector(`#blog-cover-dropzone`),e=>{a.value=e,c(e),i(`Blog cover uploaded`)}),n.querySelector(`#blog-form`).addEventListener(`submit`,async a=>{a.preventDefault();let o=new FormData(a.target),s=Object.fromEntries(o.entries());s.isPublished=a.target.querySelector(`#isPublished`).checked;let c=a.target.querySelector(`button[type="submit"]`);c.disabled=!0,c.innerHTML=`<div class="loading-spinner" style="width:16px;height:16px"></div> Saving...`;let l;if(l=t?await r(`/blog/${e.id}`,{method:`PUT`,body:JSON.stringify(s)}):await r(`/blog`,{method:`POST`,body:JSON.stringify(s)}),l?.error){i(l.error,`error`),c.disabled=!1,c.innerHTML=t?`Update Post`:`Create Post`;return}i(`Post ${t?`updated`:`created`}`),n.remove(),d()})}async function y(e){let t=await r(`/testimonials`);t&&(e.innerHTML=`
    <div class="page-header">
